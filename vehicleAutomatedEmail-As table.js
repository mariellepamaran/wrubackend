            ...
            process = function(clientName){
                ...
                vehiclesCollection.find({}).toArray().then(docs => {
                    ...
                    transporter.sendMail({
                        ...
                        // cc: ["mariellepamaran@gmail.com"], // list of receivers
                        subject: `${CLIENT_NAME[clientName]} Truck Data - ${date}`,
                        text: emailTemplate(data),
                    ...
                    //         // cc: ["pamarannw@bsp.gov.ph"], // list of receivers
                    //         subject: `${CLIENT_NAME[clientName]} Truck Data - ${date}`,
                    //         text: "",
                    //         html: "",
            ...
            emailTemplate = function(obj){
                ...
                obj.forEach(val => {
                    detailsHTML += `<tr>
                                        <td>${val["Truck"]}</td>
                                        <td>${val["Trailer"]}</td>
                                        <td>${val["Equipment Number"]}</td>
                                        <td>${val["Tractor Conduction"]}</td>
                ...
                return `<html lang="en">
                            ...
                            <body>
                                <div>Good day,</div>
                                <br>
                                <div>Here is the truck data report for ${date}:</div>
                                <br>
                                <table>
                                    <thead>
                                        <tr>
