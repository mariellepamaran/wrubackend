...
exports.eventsCT2 = (req, res) => {
    ...
    try {
        ...
        request({
            method: 'GET',
            url: `https://asia-east2-secure-unison-275408.cloudfunctions.net/eventsCT2xDev?${queryString}`,
        });
    } catch (error){
    ...
    // declare event urls
    const eventShipmentURL = "https://asia-east2-secure-unison-275408.cloudfunctions.net/eventsCT2_Shipments";
