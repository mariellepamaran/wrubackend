 ...
 */
 ...
 exports.eventsWilconxDev = (req, res) => {
     ...
     // declare event urls
     const eventShipmentURL = "https://asia-east2-secure-unison-275408.cloudfunctions.net/eventsWilconxDev_Shipments";
