...
exports.escalationDev = (req, res) => {
    ...
    // PRODUCTION
    // const websiteLink = "https://wrudispatch.azurewebsites.net";
    // DEVELOPMENT
    const websiteLink = "https://wrudispatch-dev.azurewebsites.net";
    ...
    co(function*() {
        ...
        const CLIENT_OPTIONS = {
            "wd-coket1":{ pathName: "CokeT1", ot: "origin-based" },
            "wd-wilcon":{ pathName: "Wilcon", overCICO: "startAt-startOfShift" },
        };
            ...
            regionsCollection.find({}).toArray().then(rDocs => {
                ...
                clustersCollection.find({}).toArray().then(cDocs => {
                    ...
                    geofencesCollection.find({}).toArray().then(gDocs => {
                        ...
                        // also retrieve the route and vehicle of each entry
                        dispatchCollection.aggregate([
                            ...
                            if(docs.length > 0){
                                ...
                                docs.forEach(val => {
                                    ...
                                    val.vehicle = val.vehicle || {}; // because of $unwind
