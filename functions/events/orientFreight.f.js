...
exports = module.exports = functions.region('asia-east2').runWith({ timeoutSeconds: 60, memory: '128MB' }).https.onRequest((req, res) => {
    ...
    try {
        ...
        request({
            method: 'GET',
            url: `https://asia-east2-secure-unison-275408.cloudfunctions.net/eventsOrientFreightxDev?${queryString}`,
        });
    } catch (error){
    ...
    // declare event urls
    const eventShipmentURL = "https://asia-east2-secure-unison-275408.cloudfunctions.net/eventsOrientFreightShipments";
