...
const uri =
  "mongodb://wru:7t0R3DyO9JGtlQRe@wru-shard-00-00.tyysb.mongodb.net:27017,wru-shard-00-01.tyysb.mongodb.net:27017,wru-shard-00-02.tyysb.mongodb.net:27017/wru?ssl=true&replicaSet=atlas-d1iq8u-shard-0&authSource=admin&retryWrites=true&w=majority";
...
exports = module.exports = functions
  ...
  .https.onRequest((req, res) => {
    ...
    try {
      ...
      request({
        method: "GET",
        url: `https://asia-east2-secure-unison-275408.cloudfunctions.net/eventsFuelxDev?${queryString}`,
      });
    } catch (error) {
    ...
    // declare event urls
    const eventShipmentURL =
      "https://asia-east2-secure-unison-275408.cloudfunctions.net/eventsCokeT1Shipments";
    const eventCICOURL =
      "https://asia-east2-secure-unison-275408.cloudfunctions.net/eventsCokeT1Cico";
