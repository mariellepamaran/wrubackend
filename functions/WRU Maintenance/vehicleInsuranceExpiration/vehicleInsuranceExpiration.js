...
exports.vehicleInsuranceExpiration = (req, res) => {
    ...
    try { request({ method: 'GET', url: `https://asia-east2-secure-unison-275408.cloudfunctions.net/vehicleInsuranceExpirationxDev` }); } 
